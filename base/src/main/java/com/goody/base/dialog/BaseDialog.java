...
public abstract class BaseDialog<T, E extends ViewBinding> extends Dialog implements DefaultLifecycleObserver {
    protected E binding;
    ...
    public BaseDialog(@NonNull Context context, int themeResId, LifecycleOwner owner, OnBaseListener<T> onBaseListener) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (owner != null) {
            ...
            try {
                ...
                Log.i(TAG, "BaseDialog: LifecycleOwner 失败 Context 非来自 ComponentActivity 以及他的子类");
            }
        }
        initDialog();
    }
